...
#SBATCH --job-name=indexing_reference
#SBATCH --output=../logfiles/indexing_reference_%J.out   # Standard output
#SBATCH --error=../logfiles/indexing_reference_%J.err    # Standard error
